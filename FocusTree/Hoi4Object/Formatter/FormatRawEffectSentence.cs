...
namespace FocusTree.Hoi4Object.IO.Formatter
{
    ...
    internal class FormatRawEffectSentence
    {
        ...
        /// 可以创建阵营
        /// </summary>
        static string Pattern_Single_CreateCampAvailability = "^(可以|不可以)(?:创建阵营)";
        /// <summary>
        /// 复语句-获得|移除标签
        ...
        private static bool SinglePatternFormatter(string str, out Sentence formatted)
        {
            ...
            else if(GetMatch(str, Pattern_Single_CreateCampAvailability, out match))
            {
                formatted = new(
                    match.Groups[1].Value == "可以" ? PublicSign.Motions.UpperModify : PublicSign.Motions.LowerModify,
                    PublicSign.AvailabilityObjects.CreateFaction,
                    null,
                    null,
                    null,
                    null
            ...
            {
                formatted = new(
                    PublicSign.Motions.NoneButMayChange,
                    null,
                    null,
                    null,
                    null,
